...
def main():
    ...
    # 1. Consulta por agente DESHABILITADA temporalmente
    # ConsultaCuitOTitular ignora strAgente y devuelve toda la base (9750 marcas)
    # Pendiente: consultar al INPI el formato correcto de strAgente
    # (escribir a infomarcas@inpi.gob.ar)
    logging.info("Consulta por agente pendiente de clarificacion con INPI.")
    nuevas = []
